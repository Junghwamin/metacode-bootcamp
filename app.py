...
def main() -> None:
    ...
    chapters = [
        ...
        (9, "통계의 기초와 데이터", "중심경향, 산포도, 상관"),
        (10, "확률과 확률변수", "확률, 베이즈, 기대값"),
        (11, "확률분포", "이항, 정규, CLT"),
        (12, "통계적 추정과 검정", "신뢰구간, 가설검정"),
        (13, "두 모집단 비교와 분산분석", "t검정, ANOVA"),
        (14, "회귀분석", "최소제곱법, R², 잔차"),
        (15, "Pandas 데이터 분석", "DataFrame, groupby, merge"),
        (16, "데이터 시각화 with Plotly", "bar, line, scatter"),
        (17, "마케팅 데이터 분석 실전", "기여분석, ROAS, CPC"),
    ]
